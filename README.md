...
- **Zoom roda & kanvas R–X** — `node tools/plane-zoom.test.js`: `wheelZoomFactor` (±8% per 100 px gulir; trackpad lebih landai) + `renderPlane` adaptif terhadap ukuran kanvas aktual (diagram mengisi kartu, toolbar zoom overlay).
