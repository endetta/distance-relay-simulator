...
- **Zoom & jendela R–X** — `node tools/plane-zoom.test.js`: `wheelZoomFactor` (±15% per 100 px gulir) + `pinchZoomFactor` (pinch dua-jari: renggangan = zoom in), jendela default diperlebar ×1.26 dengan margin rata, kanvas adaptif (diagram mengisi kartu, toolbar zoom sebagai chip di dalam plot).
